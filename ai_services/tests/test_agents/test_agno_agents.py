                        ...
                        [
                            {
                                "id": 3,
                                "priority_score": 95,
                                "reasoning": "Critical medical emergency",
                            },
                            {
                                "id": 1,
                                "priority_score": 80,
                            ...
                            },
                            {
                                "id": 2,
                                "priority_score": 60,
                                "reasoning": "Medium severity flood",
                            },
                        ]
                    )
                )
...
class TestAssignmentAgent:
    ...
    async def test_assign_resources(self, assignment_agent, mock_openai):
        ...
        request = {"id": 1, "type": "FIRE", "location": "Downtown", "priority": "HIGH"}
                    ...
                    content=json.dumps(
                        {
                            "assignments": [
                                {
                                    "resource_id": 1,
                                    "reasoning": "Fire truck needed for fire emergency",
                                },
                                {
                                    "resource_id": 2,
                                    "reasoning": "Ambulance for potential injuries",
                                },
                            ],
...
class TestCommunicationAgent:
    ...
    async def test_generate_notifications(self, communication_agent, mock_openai):
        ...
        result = await communication_agent.generate_notifications(
...
class TestAgentCoordination:
    ...
    async def test_full_agent_workflow(self, mock_openai, mock_supabase):
        ...
        communications = await communication_agent.generate_notifications(
            assigned, mock_stakeholders
        )
