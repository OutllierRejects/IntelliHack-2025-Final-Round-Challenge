...
class TestIncidentEndpoints:
    ...
    def test_get_incidents(self, test_client, mock_supabase):
        ...
        mock_supabase.table.return_value.select.return_value.execute.return_value.data = mock_incidents
    ...
    def test_get_incident_by_id(self, test_client, mock_supabase):
        ...
        mock_supabase.table.return_value.select.return_value.eq.return_value.execute.return_value.data = [mock_incident]
...
class TestResourceEndpoints:
    ...
    def test_get_resources(self, test_client, mock_supabase):
        ...
        mock_supabase.table.return_value.select.return_value.execute.return_value.data = mock_resources
...
class TestUserEndpoints:
    ...
    def test_user_login(self, test_client, mock_supabase):
        ...
        with pytest.MonkeyPatch().context() as mp:
            ...
            mp.setattr("services.auth_service.create_access_token", lambda x: "mock_jwt_token")
