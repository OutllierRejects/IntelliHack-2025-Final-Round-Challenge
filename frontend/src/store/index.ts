...
import type { AuthUser, HelpRequest, Task, Resource, Notification, DashboardStats } from '../types'
...
export const useRequestStore = create<RequestState>()(
  devtools(
    (set) => ({
      ...
      setLoading: (isLoading) => set({ isLoading }, false, 'requests/setLoading'),
...
export const useResourceStore = create<ResourceState>()(
  devtools(
    (set) => ({
      ...
      lowStockResources: [],
      isLoading: false,
      setResources: (resources) => set({ resources }, false, 'resources/setResources'),
      addResource: (resource) => 
        set((state) => ({ 
          resources: [resource, ...state.resources] 
        }), false, 'resources/addResource'),
      updateResource: (id, updates) =>
        set((state) => ({
          resources: state.resources.map(resource => 
            resource.id === id ? { ...resource, ...updates } : resource
          )
        }), false, 'resources/updateResource'),
      setLowStockResources: (lowStockResources) => 
        set({ lowStockResources }, false, 'resources/setLowStockResources'),
      setLoading: (isLoading) => set({ isLoading }, false, 'resources/setLoading'),
    }),
    { name: 'resource-store' }
  )
)
...
export const useNotificationStore = create<NotificationState>()(
  devtools(
    (set) => ({
      ...
      setLoading: (isLoading) => set({ isLoading }, false, 'notifications/setLoading'),
    }),
...
export const useDashboardStore = create<DashboardState>()(
  devtools(
    (set) => ({
      ...
      setLoading: (isLoading) => set({ isLoading }, false, 'dashboard/setLoading'),
      setLastUpdated: (lastUpdated) => set({ lastUpdated }, false, 'dashboard/setLastUpdated'),
    }),
